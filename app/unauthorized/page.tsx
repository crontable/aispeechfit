...
export default function UnauthorizedPage() {
  ...
  const subscriptionRequestUrl = user?.email
    ? `${SUBSCRIPTION_REQUEST_FORM_URL}${user.email}`
    : SUBSCRIPTION_REQUEST_FORM_URL;
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-blue-100 to-blue-50">
      ...
      <div className="relative w-full max-w-md px-4 py-8 text-center">
        ...
        <div className="flex justify-center">
          <Button asChild>
            <a href={subscriptionRequestUrl} target="_blank" rel="noopener noreferrer">
              이용권 신청하기
            </a>
          </Button>
        </div>
